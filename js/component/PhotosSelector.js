...
export class PhotosSelector extends Component {
  ...
  render() {
    ...
    return(
      <View style={[localStyles.outerContainer, this.props.style]}>
        <ListView style={localStyles.scrollView} data={this.state.dataSource}
          renderItem={this._getRow} onLayout={this._storeDimensions}/>
        {this._getTabBar()}
      </View>
    );
  }
  ...
  _getCameraRollAssets() {
    ...
    CameraRoll.getPhotos({
      ...
      this._filterPhotos(retValue.edges, photos);
